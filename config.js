...
// Auth information
global.pairNumber = "33780936436";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["33780936436", "33780936436"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["33780936436", "33780936436"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["33780936436"];
global.OwnerName = process.env.OWNER_NAME || "𝛭𝛥𝛨𝛪𝑇𝛩";
global.BotName = process.env.BOT_NAME || "𝛭𝛥𝛨𝛪𝑇𝛩";
global.packname = process.env.PACK_NAME || "𝛭𝛥𝛨𝛪𝑇𝛩";
